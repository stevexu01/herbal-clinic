package com.pnpinfos.herbalclinic.web.rest;

import com.pnpinfos.herbalclinic.config.KafkaProperties;
...
class HerbalClinicKafkaResourceIT {
    ...
    void setup() {
        ...
        HerbalClinicKafkaResource kafkaResource = new HerbalClinicKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/herbal-clinic-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/herbal-clinic-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
