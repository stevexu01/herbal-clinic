...
@RestController
@RequestMapping("/api/herbal-clinic-kafka")
public class HerbalClinicKafkaResource {

    private final Logger log = LoggerFactory.getLogger(HerbalClinicKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public HerbalClinicKafkaResource(KafkaProperties kafkaProperties) {
