package com.pnpinfos.herbalclinic.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("herbalClinic");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("herbalClinic");
        ...
        config.getMapConfigs().put("com.pnpinfos.herbalclinic.domain.*", initializeDomainMapConfig(jHipsterProperties));
